...
import { computeMedicationDoseSummary, type TodayLog, type TodaySnooze } from "@/components/medicacao/daily-doses-card";
...
// tomar agora) fica em "Doses de hoje" (/medicacao).
...
export default async function MeusMedicamentosPage({
  searchParams,
}: {
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-8">
      <Link href="/medicacao" className="inline-block text-sm text-emerald-400 hover:underline">
        ← Doses de hoje
      </Link>
      ...
      <form method="get" className="flex items-center gap-2">
        ...
        {busca ? (
          <a href="/medicacao/medicamentos" className="text-xs text-zinc-500 hover:text-zinc-300">
            limpar
          </a>
        ) : null}
      </form>
