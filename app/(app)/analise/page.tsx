...
export default async function AnaliseResumoPage() {
  if (!isSupabaseConfigured()) {
    return (
      <div className="mx-auto max-w-3xl space-y-4">
        <p className="text-sm text-zinc-500">
          Configure o Supabase para gerar o resumo de risco a partir dos seus registros.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-8">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h2 className="text-xl font-semibold text-zinc-50">Resumo de risco</h2>
          <p className="mt-1 max-w-xl text-sm text-zinc-400">
            ...
            avaliação médica. Correlações descritivas ficam na aba <span className="text-zinc-300">Correlações</span>.
          </p>
        </div>
        <div className="flex flex-wrap items-center gap-2">
          {latest ? (
