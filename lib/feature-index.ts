...
export const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    what: "O que dos seus medicamentos e suplementos ativos interage entre si, e o que a base não reconhece.",
    terms: [
      "interação",
      "interacao",
      "interage",
      "conflito",
      "berberina",
      "suplemento com remédio",
      "contraindicação",
    ],
  },
  {
    title: "Plano de hipoglicemia",
    href: "/perfil/hipoglicemia",
    where: ["Perfil", "Hipoglicemia"],
    what: "O que fazer quando a glicemia cai — a conduta que você definiu com seu médico, o limiar e o tempo até reavaliar.",
    terms: [
      "hipoglicemia",
      "hipo",
      "plano de hipo",
